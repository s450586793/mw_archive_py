...
- 本次重点：配置页新增本地 3MF 整理入口；支持固定目录一键整理、重复文件分离与耗时统计；Docker 新增独立整理目录挂载。
- 同步人：AI（Codex）
- 备注：同步根 `README.md` 当前版本区块，补充 `v5.5.2` 发布日志与 Docker / 配置说明。

#### 2026-03-10 10:00
- 版本号：`v5.5.1`
- 更新说明链接：[`doc/logs/v5.5.1_update_log.md`](./v5.5.1_update_log.md)
- 本次重点：在线模型支持直接编辑归档内容；首页新增收藏夹功能；首页支持简约显示模式。
- 同步人：AI（Codex）
- 备注：同步根 `README.md` 当前版本区块，补充 `v5.5.1` 发布日志与升级说明。
